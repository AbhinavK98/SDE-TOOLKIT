# HashMap Complement Pattern Cheatsheet
    ...
    |---|---|---|
    | Two Sum | O(n^2) or problem-specific | O(n) / optimal for pattern |
| Contains Duplicate | O(n^2) or problem-specific | O(n) / optimal for pattern |
| Two Sum II - Input Array Is Sorted | O(n^2) or problem-specific | O(n) / optimal for pattern |
