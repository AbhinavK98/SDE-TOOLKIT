# Prefix Sum Pattern Cheatsheet
    ...
    |---|---|---|
    | Running Sum of 1D Array | O(n^2) or problem-specific | O(n) / optimal for pattern |
| Find Pivot Index | O(n^2) or problem-specific | O(n) / optimal for pattern |
| Range Sum Query - Immutable | O(n^2) or problem-specific | O(n) / optimal for pattern |
