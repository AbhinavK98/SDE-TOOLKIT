# Sliding Window Pattern Cheatsheet
    ...
    |---|---|---|
    | Maximum Average Subarray I | O(n^2) or problem-specific | O(n) / optimal for pattern |
| Minimum Size Subarray Sum | O(n^2) or problem-specific | O(n) / optimal for pattern |
