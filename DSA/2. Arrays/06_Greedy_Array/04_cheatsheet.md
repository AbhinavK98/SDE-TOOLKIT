# Greedy on Arrays Pattern Cheatsheet
    ...
    |---|---|---|
    | Best Time to Buy and Sell Stock | O(n^2) or problem-specific | O(n) / optimal for pattern |
| Majority Element | O(n^2) or problem-specific | O(n) / optimal for pattern |
| Product of Array Except Self | O(n^2) or problem-specific | O(n) / optimal for pattern |
| Next Permutation | O(n^2) or problem-specific | O(n) / optimal for pattern |
