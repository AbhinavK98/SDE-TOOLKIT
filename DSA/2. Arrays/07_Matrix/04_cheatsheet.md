# Matrix Pattern Cheatsheet
    ...
    |---|---|---|
    | Rotate Image | O(n^2) or problem-specific | O(n) / optimal for pattern |
| Set Matrix Zeroes | O(n^2) or problem-specific | O(n) / optimal for pattern |
