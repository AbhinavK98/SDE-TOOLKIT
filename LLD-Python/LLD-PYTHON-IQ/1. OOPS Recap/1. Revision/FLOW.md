# OOP Revision — Classes, Encapsulation, Inheritance, Abstraction — Execution Flow
...
| 4 | Run each file independently: `python classes_objects.py` |
...
**Flow:** Run each file independently: `python classes_objects.py`
