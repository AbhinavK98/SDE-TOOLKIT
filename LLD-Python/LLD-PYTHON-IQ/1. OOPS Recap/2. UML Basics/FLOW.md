# UML Relationships — Association, Aggregation, Composition, Inheritance, Dependency — Execution Flow
...
| 4 | Run each numbered file to see printed relationships |
...
**Flow:** Run each numbered file to see printed relationships
