# UML Relationships — Association, Aggregation, Composition, Inheritance, Dependency — Interview Q&A

---

## Core Questions

### 1. What problem does UML Relationships solve?

**Answer:** In interviews you must draw boxes and arrows. Confusing association with composition loses credibility instantly.

---

### 2. Explain the real-world analogy.

**Answer:** **Teacher teaches Student** (association). **Department has Students** who exist independently (aggregation). **Car owns Engine** — engine dies with car (composition).

---

### 3. Walk through the code in this folder.

**Answer:** Key classes: `Teacher/Student, Department/Student, Car/Engine, Animal/Dog, Printer/Document`. Flow: Run each numbered file to see printed relationships.
...
> **In interviews you must draw boxes and arrows. Confusing association with composition loses credibility instantly....** This folder shows the fix.
