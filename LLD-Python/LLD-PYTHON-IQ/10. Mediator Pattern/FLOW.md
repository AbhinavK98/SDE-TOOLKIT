# Mediator Pattern — Execution Flow
...
| 4 | Airplane.send_message → tower.broadcast → others.receive_message |
...
**Flow:** Airplane.send_message → tower.broadcast → others.receive_message
