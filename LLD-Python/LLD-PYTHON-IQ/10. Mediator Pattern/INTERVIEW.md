# Mediator Pattern — Interview Q&A
...
**Answer:** Airplanes talking directly to each other creates N² connections. Adding a flight requires updating every plane.

---

### 2. Explain the real-world analogy.

**Answer:** **Air traffic control tower** — planes don't radio each other; they go through the tower.

---

### 3. Walk through the code in this folder.

**Answer:** Key classes: `AirTrafficControl, ControlTower, Airplane`. Flow: Airplane.send_message → tower.broadcast → others.receive_message.
...
> **Airplanes talking directly to each other creates N² connections. Adding a flight requires updating every plane....** This folder shows the fix.
