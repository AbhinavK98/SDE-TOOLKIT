# Abstract Factory Pattern — Execution Flow
...
| 4 | RestaurantService(NorthIndianCuisine) → create_meal → prepare all three |
...
**Flow:** RestaurantService(NorthIndianCuisine) → create_meal → prepare all three
