# Abstract Factory Pattern — Interview Q&A

---

## Core Questions

### 1. What problem does Abstract Factory Pattern solve?

**Answer:** Restaurant must serve consistent cuisine families — North Indian starter+main+dessert together. One factory per cuisine.

---

### 2. Explain the real-world analogy.

**Answer:** **IKEA room sets** — pick Scandinavian vs Industrial; get matching sofa, table, lamp from one factory.

---

### 3. Walk through the code in this folder.

**Answer:** Key classes: `Starter, MainCourse, Dessert, CuisineFactory, NorthIndianCuisine`. Flow: RestaurantService(NorthIndianCuisine) → create_meal → prepare all three.
...
| Bad | Good |
|-----|------|
| RestaurantService creates all dishes with if cuisine == north_indian | CuisineFactory creates starter, main, dessert; NorthIndianCuisine, ChineseCuisine |
...
> **Restaurant must serve consistent cuisine families — North Indian starter+main+dessert together. One factory per cuisine....** This folder shows the fix.
