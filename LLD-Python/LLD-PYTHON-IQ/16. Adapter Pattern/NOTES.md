...
**Power plug adapter** — US plug into EU socket. Same electricity, different interface.
...
| File | Purpose |
|------|--------|
| `pattern.py` | SendGridAdapter + OrderService demo |
...
**Key classes:** `NotificationService, SendGridAdapter, SendGridEmailService, OrderService`
...
Adapter Pattern teaches you to structure objects so systems grow without breaking. Master the **intent**, draw the **diagram**, then read the **code**.
