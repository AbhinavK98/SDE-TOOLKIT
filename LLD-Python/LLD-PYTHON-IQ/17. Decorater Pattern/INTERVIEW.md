# Decorator Pattern — Interview Q&A
...
**Answer:** Coffee + milk + whip + sugar needs combinatorial subclasses: CoffeeWithMilkAndWhipAndSugar.

---

### 2. Explain the real-world analogy.

**Answer:** **Subway sandwich** — start with bread, add toppings one layer at a time. Each topping wraps the previous.

---

### 3. Walk through the code in this folder.

**Answer:** Key classes: `Beverage, Coffee, AddOnDecorator, MilkDecorator, WhipCreamDecorator`. Flow: Coffee → MilkDecorator → WhipCreamDecorator → get_cost().
...
> **Coffee + milk + whip + sugar needs combinatorial subclasses: CoffeeWithMilkAndWhipAndSugar....** This folder shows the fix.
