...
**Answer:** Loading 4 high-res images at gallery open takes 4 seconds. User may only view one.

---

### 2. Explain the real-world analogy.

**Answer:** **Netflix thumbnail** — you see preview instantly; full movie loads when you press play.

---

### 3. Walk through the code in this folder.

**Answer:** Key classes: `HighResImage, ImageProxy, PhotoGallery`. Flow: add_image (fast) → show_image(2) → load once → cache.
...
> **Loading 4 high-res images at gallery open takes 4 seconds. User may only view one....** This folder shows the fix.
