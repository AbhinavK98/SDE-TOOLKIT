# Single Responsibility Principle (SRP) — Execution Flow
...
| 4 | main creates User → UserRepository.save_to_database(user) |
...
**Flow:** main creates User → UserRepository.save_to_database(user)
