# Open/Closed Principle (OCP) — Execution Flow
...
| 4 | Create UPIPayment → PaymentProcessor.process_payment(upi, 100) |
...
**Flow:** Create UPIPayment → PaymentProcessor.process_payment(upi, 100)
