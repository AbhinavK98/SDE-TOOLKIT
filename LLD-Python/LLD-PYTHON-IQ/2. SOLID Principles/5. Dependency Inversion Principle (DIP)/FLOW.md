# Dependency Inversion Principle (DIP) — Execution Flow
...
| 4 | main → SMSService → inject into NotificationService → notify() |
...
**Flow:** main → SMSService → inject into NotificationService → notify()
