# Strategy Pattern — Interview Q&A
...
**Answer:** Discount logic buried in if/elif for Diwali, Holi, Christmas — adding festivals means editing the same method.

---

### 2. Explain the real-world analogy.

**Answer:** **Uber surge pricing** — same ride request, different pricing algorithm swapped at runtime.

---

### 3. Walk through the code in this folder.

**Answer:** Key classes: `DiscountStrategy, DiwaliStrategy, HoliStrategy, DiscountService`. Flow: DiscountService(DiwaliStrategy) → process → set_strategy(Holi) → process.
...
> **Discount logic buried in if/elif for Diwali, Holi, Christmas — adding festivals means editing the same method....** This folder shows the fix.
